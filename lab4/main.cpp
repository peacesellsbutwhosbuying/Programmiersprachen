...
void info(Queue);
void addJournal(Queue &);
void removeJournal(Queue &);
...
int main()
{
  ...
  do
  {
    ...
    switch(key) 
    {
      case 1: addJournal(prod); break;
      case 2: removeJournal(prod); break;
